...
def main():
  ...
  sshsession.connect(hostname=ipaddr, username=username, pkey=mykey)
  
  our_commands = ["touch sshworked.txt", "touch create.txt", "touch file3.txt", "ls"]
  with open('results.log', mode='w') as new_file:
    new_file.write(f"output collected from:\n  {ipaddr}\nby user: {username}\n")
...
if __name__ == '__main__':
  ipaddr = input("enter the IP to connect to: ")
  username = input("enter the username: ")
  print("Output save to 'results.log'")
  main()
